module.exports = {
    "CLOSESTTUBE_EN_GB" : {
      "in motion" : "The nearest tube station to in motion is old street"
    },
    "CLOSESTRAIL_EN_GB" : {
      "in motion" : "The nearest rail station to in motion is Shoreditch High Street"
    },
    "BURGER_EN_GB" : {
      "shoreditch" : "My burger reccomendation for Shoreditch is Red's True Barbecue - Shoreditch, 54-56 Great Eastern Street with 4 stars on Yelp"
    },
    "COFFEE_EN_GB" : {
      "birmingham" : "My reccomendation for coffee in Birmingham is Six Eight Kafé with 4.6 stars on Yelp",
      "shoreditch" : "My reccomendation for coffee in Shoreditch is Exmouth Coffee Company with 4.2 stars on Yelp",
      "in motion" : "My reccomendation for coffee near in motion is Fix 126 with 3.6 stars on Yelp",
      "yorkshire" : "My reccomendation for coffee in yorkshire is Spring Espresso with 4.7 stars on Yelp"
    },
    "TFLSTATUS" : {
      "status" : "No service between Edmonton Green and Cheshunt, Good service on all other lines"
    },
    "RECIPE_EN_GB" : {
